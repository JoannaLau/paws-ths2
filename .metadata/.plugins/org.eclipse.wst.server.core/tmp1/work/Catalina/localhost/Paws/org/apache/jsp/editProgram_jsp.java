 ...
 * Generated at: 2017-07-30 10:43:58 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"Programs\"> List of Programs </a> > Edit Program\r\n");
      out.write("\t\t\t\t\t\t</h3>\r\n");
      out.write("\t\t\t     </div>\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<form method=\"post\" action=\"UpdateProgram\" class=\"form\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card card-block sameheight-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"title-block\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h3 class=\"title\">Edit Program Form</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div style=\"width:48%; padding-right\"> <label class=\"control-label\">Program Name</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control underlined\" style=\"width:90%;\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${program.getName()}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" placeholder=\"e.g. De La Salle\" name=\"programName\"> </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${program.getProgramID()}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" name=\"programID\"> </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("<!-- \t\t\t\t\t\t\t\t\t</button> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-info\" onclick=\"alert('Successfully Edited!');location.href = 'Programs';\"  style=\"float:right; padding-right:15px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\tSubmit\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /editProgram.jsp(284,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("prog");
      // /editProgram.jsp(284,10) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setScope("session");
      // /editProgram.jsp(284,10) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/editProgram.jsp(284,10) '${program}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${program}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
