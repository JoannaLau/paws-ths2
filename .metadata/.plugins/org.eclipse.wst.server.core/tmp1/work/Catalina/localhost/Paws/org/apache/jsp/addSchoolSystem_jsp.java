 ...
 * Generated at: 2017-07-29 08:34:50 UTC
...
return;
    ...
    try {
      ...
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control underlined\" style=\"width:90%;\"  placeholder=\"e.g. 2017-01-01\" name=\"joinDate\"> </div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
