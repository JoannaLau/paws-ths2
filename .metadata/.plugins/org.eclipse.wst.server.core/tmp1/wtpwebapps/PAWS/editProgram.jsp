                ...
                <article class="content dashboard-page">
				 ...
				 <div class="title-block">
                        <h3 class="title" style="float:left;">
							<a href="Programs"> List of Programs </a> > Edit Program
						</h3>
			     </div>
				...
				<section class="section" id="section">   
				 <div class="tab-content">     
				 	<div id="menu1" class="tab-pane fade in active">          
						<form method="post" action="UpdateProgram" class="form">
						<div class="col-md-12">
									<div class="card card-block sameheight-item">
										<div class="title-block">
											<h3 class="title">Edit Program Form</h3>
									 	</div>
...
<!-- 									</button> -->
									...
									<button type="submit" class="btn btn-info" onclick="alert('Successfully Edited!');location.href = 'Programs';"  style="float:right; padding-right:15px;">
									Submit
									</button>
								</div>
						</div>
