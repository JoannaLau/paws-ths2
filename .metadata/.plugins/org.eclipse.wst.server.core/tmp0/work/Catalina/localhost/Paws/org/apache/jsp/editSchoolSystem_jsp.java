 ...
 * Generated at: 2017-07-02 11:14:30 UTC
...
public final class editSchoolSystem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("Models.SchoolSystem");
  }
...
return;
    ...
    try {
      ...
      out.write("\tvar surveyName = document.getElementById(\"surveyName\").value;\r\n");
      out.write("\tvar school = document.getElementById(\"school\").value;\r\n");
      out.write("\tvar School System = document.getElementById(\"School System\").value;\r\n");
      out.write("\t\r\n");
      out.write("\t$('#external-events').append('<div class=\"fc-event ui-draggable ui-draggable-handle\" data-event=\"{\\\"title\\\":\\\"' + surveyName + '\\\"}\">' + surveyName + '</div> <br>');\r\n");
      out.write("\t$('#external-events .fc-event').each(function() {\r\n");
      out.write("\r\n");
      out.write("\t\t// store data so the calendar knows to render an event upon drop\r\n");
      out.write("\t\t$(this).data('event', {\r\n");
      ...
      out.write("\r\n");
      out.write("\t});\r\n");
      out.write("\t$('#surveyName').value = \"\";\r\n");
      out.write("\t$('#school').value = \"\" ;\r\n");
      out.write("\t$('#School System').value = \"\";\r\n");
      out.write("\taddAlert(surveyName);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t<form method=\"post\" action=\"UpdateSchoolSystem\" class=\"form\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"card card-block sameheight-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"title-block\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h3 class=\"title\">\r\n");
      out.write("\t\t\t\t\t\t\tNew School System Form\r\n");
      out.write("\t\t\t\t\t\t</h3> </div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t");
 SchoolSystem ss = (SchoolSystem)request.getAttribute("SchoolSystem"); 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control underlined\" style=\"width:90%;\" value=\"");
      out.print(ss.getName() );
      out.write("\" placeholder=\"e.g. De La Salle\" name=\"ssName\"> </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.print(ss.getSchoolSystemID() );
      out.write("\" name=\"systemID\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div style=\"width:48%; padding-right\"> <label class=\"control-label\">Membership Date</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control underlined\" style=\"width:90%;\" value=\"");
      out.print(ss.getDateJoined());
      out.write("\" placeholder=\"e.g. 2017-01-01\" name=\"joinDate\"> </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("<!-- \t\t\t\t\t\t\t\t\t</button> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-info\" onclick=\"alert('Successfully Edited!');location.href = 'SchoolSystems';\"  style=\"float:right; padding-right:15px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\tSubmit\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
