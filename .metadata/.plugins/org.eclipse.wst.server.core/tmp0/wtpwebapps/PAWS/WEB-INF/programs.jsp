...
$(document).ready(function() {
    ...
    $('#smarttable').DataTable( {
		...
		document.location.href='programProfile.html';
		} );
		...
		<video poster="assets/banner.jpg" id="bgvid"  playsinline autoplay muted loop>
			...
			<source src="assets/vid.mp4" type="video/mp4">
						...
						<h1>List of Programs</h1>
									...
									<button type="button"  style="float:right; position:relative;left:-50px; top:-52px; color:#3c4731;" class="btn btn-oval btn-secondary" onclick="location.href='addProgram.jsp';"><em class="fa fa-plus"></em><b> Add Program</b></button>
                        ...
                        <div class="table-responsive" style="width:100%; float:right;" id="contenthole">
							<table id="smarttable" class="table table-striped table-bordered table-hover">
                               ...
                               <tbody>
									...
									<tr>
										<td> <c:out value="${program.getProgramID()}"/> </td>
