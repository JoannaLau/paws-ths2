					...
					<section class="section" id="section3">
						...
						<div class="card card-block sameheight-item">
							<form role="form" class="form-inline">
								<div class="form-group form-inline">
									<div class="title-block">
										<h3 class="title"> PAASCU Rep 1: </h3>
									</div>
									...
									<div class="form-group" style="width:48%; padding-right"> <label class="control-label">Contact Number</label> <input type="text" id="paascu1Contact" style="width:90%;" class="form-control underlined"  placeholder="e.g. 0999-999-999"> </div>
								</div>
							</form>
						</div>
						<div class="card card-block sameheight-item">
							<form role="form" class="form-inline">
								<div class="form-group form-inline">
									<div class="title-block">
										<h3 class="title"> PAASCU Rep 2: (Leave blank if unnecessary) </h3>
									</div>
									...
									<div class="form-group" style="width:48%; padding-right"> <label class="control-label">Contact Number</label> <input type="text" id="paascu2Contact" style="width:90%;" class="form-control underlined"  placeholder="e.g. 0999-999-999"> </div>
								</div>
							</form>
						</div>
						<button type="button" class="btn btn-success" onclick="addProp();" data-toggle="tab" href="#menu2" style="float:right;">
