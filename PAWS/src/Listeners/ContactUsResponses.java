...
/**
 * Servlet implementation class ContactUsResponses
 */
@WebServlet("/ContactUsResponses")
public class ContactUsResponses extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ContactUsResponses() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ContactUs> contactUs = cuUtil.getAllContactUs();
