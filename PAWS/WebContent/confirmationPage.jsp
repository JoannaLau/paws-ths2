...
alert(type);
	...
	if(type=="Interim"){return "'interimConfirm("+i+","+ID+","+decisionJSON+")'"};
}
...
function interimConfirm(PSID, surveyID, decisionJSON){
	var add = "";	
var opt1="", opt2="";
...
$('#modalBody2').html("<div style='width: 49%; float:left;'><h4>Interim Survey</h4></div>");
...
function revisitConfirm(PSID, surveyID, decisionJSON) {	
	var add = "";	
 ...
 //  START OF TEAM TAB CONTENT	-PRELIMINARY
 	...
 	add +=("<input type='hidden'  name='optionID_team' id='optionID_team'><input type='hidden' name='PSID' value='"+PSID+"'><input type='hidden' name='surveyID' value='"+surveyID+"'><input type='hidden' name='type'value='Resurvey'>");
	  ...
	  //  START OF TEAM TAB CONTENT	-PRELIMINARY
	  	...
	  	add+=("<div id='committee' class='tab-pane fade in active'>");
	    	add += ("<div class='form-group' style='width:100%;'> <div>"); 
	  	add +=("<input type='hidden'  name='optionID_committee' id='optionID_committee'><input type='hidden' name='PSID' value='"+PSID+"'><input type='hidden' name='surveyID' value='"+surveyID+"'><input type='hidden' name='type'value='Resurvey'>");
	 		 ...
	 		 if(value.option == "rsOpt1") opt1 = "checked";
	    		 ...
	    		 add += ("<label class='control-label' style='width:100%;'><br><input "+opt1+" onclick='updateOptionID_committee(\"rsOpt1\")' name='opt_committee' class='radio ' type='radio'>	<span>Re-accreditation for a period of <select name='yearRsOpt1_committee'><option>three</option><option>four</option><option selected='selected'>five</option><option>six</option><option>seven</option></select> years</span>  <br> <hr></label>");
	    	
	    		 add += ("<label><input "+opt2+" onclick='updateOptionID_committee(\"rsOpt2\")' name='opt_committee'class='radio' type='radio' >   <span>Re-accreditation after <select name='yearRsOpt2_committee'><option "+three+">three</option><option "+four+">four</option><option "+five+">five</option><option "+six+">six</option><option "+seven+">seven</option></select> years with a WRITTEN PROGRESS REPORT on the <select name='year2RsOpt2_committee'><option "+fir+">1st</option><option "+sec+">2nd</option><option "+thi+">3rd</option><option "+fou+">4th</option><option "+fif+">5th</option><option "+six2+">6th</option><option "+sev+">7th</option></select> year on the following areas:</span> <select id='2areaSelect"+PSID+"_committee'><option></option><option>Faculty</option><option>Curriculum and Instructions</option><option>Laboratories</option><option>Libraries</option><option>Community</option><option>Physical Facilities</option><option>Student Services</option><option>Administration</option><option>Research</option><option>Clinical Training</option><option>Other Resources</option></select> <em id='addicon' style='margin-left:5px;' class='fa fa-plus' onclick='addAreaTeam2("+PSID+")'></em> <em id='addicon' style='margin-left:5px;'class='fa fa-undo' onclick='resetAreaTeam2("+PSID+")'></em> </label> <br>");
	   		 add += ("<div class='form-group'> <label class='control-label'>Areas</label> <br> <textarea id='2remarks"+PSID+"_committee' name='areasRsOpt2_committee' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	    		 
	    		 
	   		 add += ("<label><input "+opt3+" onclick='updateOptionID_committee(\"rsOpt3\")' name='opt_committee'class='radio' type='radio'>   <span>Re-accreditation for <select name='yearRsOpt3_committee'><option "+three+">three</option><option "+four+">four</option><option "+five+"'>five</option><option "+six+">six</option><option "+seven+">seven</option></select> years with a INTERIM VISIT on the</span><span><select name='year2RsOpt3_committee'><option "+fir+">1st</option><option "+sec+">2nd</option><option "+thi+">3rd</option><option "+fou+">4th</option><option "+fif+">5th</option><option "+six2+">6th</option><option "+sev+">7th</option></select>  year on the following areas:</span>  <br> <select id='3areaSelect"+PSID+"_committee'><option></option><option>Faculty</option><option>Curriculum and Instructions</option><option>Laboratories</option><option>Libraries</option><option>Community</option><option>Physical Facilities</option><option>Student Services</option><option>Administration</option><option>Research</option><option>Clinical Training</option><option>Other Resources</option></select> <em id='addicon' style='margin-left:5px;' class='fa fa-plus' onclick='addAreaTeam3("+PSID+")'></em> <em id='addicon' style='margin-left:5px;'class='fa fa-undo' onclick='resetAreaTeam3("+PSID+")'></em> </label> <br>");
	  		 add += ("<div class='form-group'> <label class='control-label'>Areas</label> <br> <textarea id='3remarks"+PSID+"_committee' name='areasRsOpt3_committee' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	   		 
	   		 
	    	
	      	 add += ("<label> <input "+opt4+" onclick='updateOptionID_committee(\"rsOpt4\")' name='opt_committee'class='radio' type='radio'>  <span>Re-accreditation deferred</span> </label> <br>");
	   		 add += ("<div class='form-group'> <label class='control-label'>Reason(s) for deferment:</label> <br> <textarea id='reasonRsOpt4' name='reasonsRsOpt4_committee' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	    	 add += ("</div> </div>");
	    	 add += ("</div>")    
	    		  ...
	    		  //  START OF TEAM TAB CONTENT	-PRELIMINARY
	    		  	...
	    		  	add+=("<div id='board' class='tab-pane fade in active'>");
	    		    	add += ("<div class='form-group' style='width:100%;'> <div>"); 
	    		  	add +=("<input type='hidden'  name='optionID_board' id='optionID_board'><input type='hidden' name='PSID' value='"+PSID+"'><input type='hidden' name='surveyID' value='"+surveyID+"'><input type='hidden' name='type'value='Resurvey'>");
	    		 		 ...
	    		 		 if(value.option == "rsOpt1") opt1 = "checked";
	    		    		 ...
	    		    		 add += ("<label class='control-label' style='width:100%;'><br><input "+opt1+" onclick='updateOptionID_board(\"rsOpt1\")' name='opt_board' class='radio ' type='radio'>	<span>Re-accreditation for a period of <select name='yearRsOpt1_board'><option>three</option><option>four</option><option selected='selected'>five</option><option>six</option><option>seven</option></select> years</span>  <br> <hr></label>");
	    		    	
	    		    		 add += ("<label><input "+opt2+" onclick='updateOptionID_board(\"rsOpt2\")' name='opt_board'class='radio' type='radio' >   <span>Re-accreditation after <select name='yearRsOpt2_board'><option "+three+">three</option><option "+four+">four</option><option "+five+">five</option><option "+six+">six</option><option "+seven+">seven</option></select> years with a WRITTEN PROGRESS REPORT on the <select name='year2RsOpt2_board'><option "+fir+">1st</option><option "+sec+">2nd</option><option "+thi+">3rd</option><option "+fou+">4th</option><option "+fif+">5th</option><option "+six2+">6th</option><option "+sev+">7th</option></select> year on the following areas:</span> <select id='2areaSelect"+PSID+"_board'><option></option><option>Faculty</option><option>Curriculum and Instructions</option><option>Laboratories</option><option>Libraries</option><option>Community</option><option>Physical Facilities</option><option>Student Services</option><option>Administration</option><option>Research</option><option>Clinical Training</option><option>Other Resources</option></select> <em id='addicon' style='margin-left:5px;' class='fa fa-plus' onclick='addAreaTeam2("+PSID+")'></em> <em id='addicon' style='margin-left:5px;'class='fa fa-undo' onclick='resetAreaTeam2("+PSID+")'></em> </label> <br>");
	    		   		 add += ("<div class='form-group'> <label class='control-label'>Areas</label> <br> <textarea id='2remarks"+PSID+"_board' name='areasRsOpt2_board' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	    		    		 
	    		    		 
	    		   		 add += ("<label><input "+opt3+" onclick='updateOptionID_board(\"rsOpt3\")' name='opt_board'class='radio' type='radio'>   <span>Re-accreditation for <select name='yearRsOpt3_board'><option "+three+">three</option><option "+four+">four</option><option "+five+"'>five</option><option "+six+">six</option><option "+seven+">seven</option></select> years with a INTERIM VISIT on the</span><span><select name='year2RsOpt3_board'><option "+fir+">1st</option><option "+sec+">2nd</option><option "+thi+">3rd</option><option "+fou+">4th</option><option "+fif+">5th</option><option "+six2+">6th</option><option "+sev+">7th</option></select>  year on the following areas:</span>  <br> <select id='3areaSelect"+PSID+"_board'><option></option><option>Faculty</option><option>Curriculum and Instructions</option><option>Laboratories</option><option>Libraries</option><option>Community</option><option>Physical Facilities</option><option>Student Services</option><option>Administration</option><option>Research</option><option>Clinical Training</option><option>Other Resources</option></select> <em id='addicon' style='margin-left:5px;' class='fa fa-plus' onclick='addAreaTeam3("+PSID+")'></em> <em id='addicon' style='margin-left:5px;'class='fa fa-undo' onclick='resetAreaTeam3("+PSID+")'></em> </label> <br>");
	    		  		 add += ("<div class='form-group'> <label class='control-label'>Areas</label> <br> <textarea id='3remarks"+PSID+"_board' name='areasRsOpt3_board' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	    		   		 
	    		   		 
	    		    	
	    		      	 add += ("<label> <input "+opt4+" onclick='updateOptionID_board(\"rsOpt4\")' name='opt_board'class='radio' type='radio'>  <span>Re-accreditation deferred</span> </label> <br>");
	    		   		 add += ("<div class='form-group'> <label class='control-label'>Reason(s) for deferment:</label> <br> <textarea id='reasonRsOpt4' name='reasonsRsOpt4_board' rows='3'  class='form-control' style='width:100%;'>"+remarksArea+"</textarea> </div>");
	    		    	 add += ("</div> </div>");
	    		    	 add += ("</div>")
