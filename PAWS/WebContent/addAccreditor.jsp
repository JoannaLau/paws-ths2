        ...
        function saveAccreditor() {
        	...
        	console.log( $('#accForm').serializeArray() );
        	  $.ajax({
                ...
                dataType: 'json',
                data: {
                    affObject: JSON.stringify(affObject)
                },
      ...
      <a href="Accreditors"> List of Accreditors </a> > Add New Accreditor
         ...
         border: 1px solid #b8b8b8;">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#afi">Work</a>
                                                    </li>
                                                    <li><a data-toggle="tab" href="#edu">Education</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div id="afi" class="tab-pane fade in active">
                                                        <div class="form-group">
                                                            ...
                                                            <label>To:
                                                                <input style="margin-left:100px;" type="checkbox" onclick="togglePresent()">Current?</label>
                                                            <div class="input-daterange input-group">
         ...
         box-shadow: inset 0px 1px 7px 1px rgba(0,0,0,0.41); padding:12px;" id="affiliations">
                                    ...
                                    <div id="navBut" style="position:absolute;top:670px;">
                                        ...
                                        <button type="button" class="btn btn-info" data-toggle="tab" href="#menu1">
                                            Back
                                        </button>
