       ...
       <div class="ui stackable inverted divided grid">
           <div class="four wide column" style="padding-right:10%;">
		        <div class="ui inverted link list">
		            ...
		            <a class="item footer-text">About PAASCU</a>
		            <br>
		            <a class="item footer-text">Board Members</a>
		            <br>
		            <a class="item footer-text">Commission Members</a>
		            <br>
		        	<a class="item footer-text">International Affiliations</a>
		            <br>
		        </div>
		    </div>
		    <div class="four wide column">
		        ...
		        <div class="ui inverted link list">
		            <a class="item footer-text">Elementary School</a>
		            <br>
		            <a class="item footer-text">Secondary School</a>
		            <br>
		            <a class="item footer-text">Integrated Basic Education</a>
		            <br>
		            <a class="item footer-text">Tertiary Education</a>
		            <br>
		            <a class="item footer-text">Graduate Education</a>
		            <br>
		            <a class="item footer-text">Medical Education</a>
		            <br>
		            <a class="item footer-text">CECSTE</a>
		         </div>
		    </div>
