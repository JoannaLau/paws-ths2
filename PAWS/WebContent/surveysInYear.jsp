...
<source src="assets/vid.mp4" type="video/mp4">
            ...
            <div id="welcome">
			<h1>Survey Visits for the year ${year}</h1>
                ...
                <article class="content dashboard-page"  >
			       ...
			       <a href="SurveyVisitInfographics"> Survey Visits </a> &nbsp;> List of Surveys Done for ${year}
    			</h3>		
