...
<style>
 ...
 j$ = jQuery.noConflict();
	j$(document).ready( function () {
		...
		if(${connection}==true)
		{
			document.getElementById("buttonSync").innerHTML = "	<button type=\"button\" style=\"float:right; position:relative;left:-50px; top:-52px; color:#3c4731;\" class=\"btn btn-oval btn-secondary\" onclick=\"location.href='./SyncBoardMembers';\"><b>SYNC</b></button>";
		}
	});
...
<source src="assets/vid.mp4" type="video/mp4">
            ...
            <div id="welcome">
			<h1>List of Unsynced Board Members</h1>
                     ...
                     <h6 style="padding-top: 10px;" id="noConnection"></h6>
											...
											<select id="yearSelect" class="chosen-single"><option value="All">All</option></select>
                                                ...
                                                <table id="smarttable" class="table table-striped table-bordered table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
														<c:forEach items="${boardMembers}" var="bm">
												        <tr onclick="window.document.location='ViewUnsyncedBoardMembers?bmID='+'${bm.getBmID()}';">
