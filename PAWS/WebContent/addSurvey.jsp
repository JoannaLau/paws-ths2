    ...
    <head>
      ...
      //BLANK FIELD CHECKERS
            ...
            function addProp() {
                ...
                institutionName.innerText = $("#institutionForm option:selected").text();
            ...
            function addProgram() {
                ...
                if ($('#divProgramForm').children().length > 0  && strUser == "") {
                    ...
                    if (document.getElementById('fac').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=1",
                            async: false,
                    ...
                    if (document.getElementById('ins').checked) {
                        ...
                        obj.areas[areaCounter]['area'] = 'Curriculum and Instructions';
                        obj.areas[areaCounter]['accreditorIDs'] = [];
                        var facCounter2 = areaCounter;

                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=2",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('lab').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=3",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('lib').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=4",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('com').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=5",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('phy').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=6",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('stus').checked) {
                        obj.areas.push({});
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=7",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('adm').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=8",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('res').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=9",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('cli').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=10",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('oth').checked) {
                        ...
                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=11",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                    ...
                    if (document.getElementById('stu').checked) {
                        obj.areas.push({});
                        obj.areas[areaCounter]['areaID'] = 12;
                        obj.areas[areaCounter]['area'] = 'Students';
                        obj.areas[areaCounter]['accreditorIDs'] = [];
                        var facCounter12 = areaCounter;

                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=12",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                                ...
                                btnTemp.appendChild(document.createTextNode('Add'));
                                btnTemp.onclick = function() {
                                    addAccreditor(document.getElementById('stu').value, programID, strSurvey, facCounter12, programCounter, this);
                    ...
                    if (document.getElementById('sap').checked) {
                        obj.areas.push({});
                        obj.areas[areaCounter]['areaID'] = 13;
                        obj.areas[areaCounter]['area'] = 'Student Activity Program';
                        obj.areas[areaCounter]['accreditorIDs'] = [];
                        var facCounter13 = areaCounter;

                        $.ajax({
                            url: "LatestAccreditor?SPID=" + programID + "&areaID=13",
                            async: false,
                            success: function(result) {
                                acc = result;
                                var rowTemp = table.insertRow();
                                rowTemp.insertCell(0).innerHTML = document.getElementById('sap').value;
                                rowTemp.insertCell(1).innerHTML = acc;
                                var btnTemp = document.createElement('BUTTON');
                                btnTemp.appendChild(document.createTextNode('Add'));
                                btnTemp.onclick = function() {
                                    addAccreditor(document.getElementById('sap').value, programID, strSurvey, facCounter13, programCounter, this);
                        ...
                        areaCounter++;
                        add += "<li class='list-group-item'>" + document.getElementById('sap').value + "</li>";
                    }
            ...
            function addAccreditor(area, program, survey, areaCounter, programCounter, btn) {
                ...
                $.ajax({ //CALLING ACCREDITORS WITH EXTRA CHECKING FOR AFFILIATION CONFLICTS
                    ...
                    url: "AccreditorsLoader?SPID=" + program + "&systemID=" + systemID + "&area=" + area + "&discipline=" + $('#programForm option:selected').val(),
                    dataType: 'json',
                    async: false,
                    success: function(data) {
                        accreditors = data;
            ...
            function selectAll() {
                ...
                document.getElementById("stus").checked = true;
            }
            ...
            <article class="content dashboard-page">
                ...
                <div class="tab-content">
                    ...
                    <div id="menu1" class="tab-pane fade in active">
                        <section class="section" id="section1">
                            ...
                            <hr>
                            <a type="button" class="btn btn-success" id="checkStep1" href="#menu2" data-toggle="tab" style="float:right;">
				...
				<section class="section" id="section2">
					<form style="height:420px; width:100%; overflow:scroll;">
							...
							<div class="card-block">
								...
								<div class="form-group">
									...
									<div style="width: 44%; float:left;">
										...
										<label><input type="checkbox" class="checkbox " value="Curriculum and Instructions" id="ins"><span>Curriculum and Instructions</span></label>
										...
										<label><input type="checkbox" class="checkbox " value="Physical Facilities" id="phy"><span>Physical Facilities</span></label>						
										<label><input type="checkbox" class="checkbox " value="Student Services" id="stus"><span>Student Services</span></label>						
									...
									<div style="width: 55%; float:right;">
										...
										<label><input type="checkbox" class="checkbox " value="Students" id="stu"><span>Students</span></label>
										<label><input type="checkbox" class="checkbox " value="Student Activity Program" id="sap"><span>Student Activity Program</span></label>
						...
						<div id="added" style="width: 49%; height: 460px; float:right; overflow: scroll;">
                            ...
                            <section class="section" id="section3">
                                    ...
                                    <form role="form" class="form-inline">
                                        <div class="form-group form-inline">
                                            <div class="title-block">
                                                <h3 class="title"> Chairperson: </h3> </div>
                                ...
                                <div class="card card-block sameheight-item">
                                    <form role="form" class="form-inline">
                                        <div class="form-group form-inline">
                                            <div class="title-block">
                                                <h3 class="title"> PAASCU Rep 1: </h3> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Name</label>
                                                <br>
                                                <input type="text" id="paascu1Name" style="width:90%;" class="form-control underlined" placeholder="e.g. Alma"> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Position</label>
                                                <input type="text" id="paascu1Position" style="width:90%;" class="form-control underlined" placeholder="e.g. Board Director"> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Contact Number</label>
                                                <input type="text" id="paascu1Contact" style="width:90%;" class="form-control underlined" placeholder="e.g. 0999-999-999"> </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card card-block sameheight-item">
                                    <form role="form" class="form-inline">
                                        <div class="form-group form-inline">
                                            <div class="title-block">
                                                <h3 class="title"> PAASCU Rep 2: (Leave blank if unnecessary) </h3> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Name</label>
                                                <br>
                                                <input type="text" id="paascu2Name" style="width:90%;" class="form-control underlined" placeholder="e.g. Alma"> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Position</label>
                                                <input type="text" id="paascu2Position" style="width:90%;" class="form-control underlined" placeholder="e.g. Board Director"> </div>
                                            <div class="form-group" style="width:48%; padding-right">
                                                <label class="control-label">Contact Number</label>
                                                <input type="text" id="paascu2Contact" style="width:90%;" class="form-control underlined" placeholder="e.g. 0999-999-999"> </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${accreditors}" var="acc">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:out value="${acc.getInstitution()}" />
                                                </td>
                                                ...
                                                <c:if test="${acc.getInstitution()}">
                                                    ...
                                                    <td style="background-color:red;">
                                                        <c:out value="${acc.getPrimaryArea()}" />
                                                    </td>
                                                </c:if>
                                                ...
                                                <td>
                                                    <c:out value="${acc.getSecondaryArea()}" />
                                                </td>
                                                <td>
                                                    <c:out value="${acc.getTotalSurveys()}" />
                                                </td>
                                                <td>
                                                    <c:out value="${acc.getCity()}" />
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="DeleteAccreditor?accreditorID=<c:out value='${acc.getAccreditorID()}'/>">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                        ...
                        <div id="modalBody" class="modal-body">
                            <div class="table-responsive" style="width:100%;" id="contenthole">
                                <form role="form" class="form-inline">
                                    <div class="form-group" style="width:48%; padding-right">
                                        <label class="control-label">Name</label>
                                        <input type="text" class="form-control underlined" style="width:90%;" placeholder="e.g. Alma"> </div>
                                    <div class="form-group" style="width:48%; padding-right">
                                        <label class="control-label">Position</label>
                                        <input type="text" class="form-control underlined" style="width:90%;" placeholder="e.g. Board Director"> </div>
                                    <div class="form-group" style="width:48%; padding-right">
                                        <label class="control-label">Contact Number</label>
                                        <input type="text" class="form-control underlined" style="width:90%;" placeholder="e.g. 0999-999-999"> </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
