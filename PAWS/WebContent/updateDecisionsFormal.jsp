			    	...
			    	$.each(data, function (key, value){
						if(data.length > 0)
						{
							if(value.decisionBy == "Board")
							{
								...
								if(value.decision == "Initial accreditation for three (3) years")
								{

									$( '#boardChoice1' ).attr('checked', 'checked');
								}
								else if(value.decision == "Accreditation not granted")
								{
        ...
        <div class="main-wrapper" style="z-index:1;">
            <div class="app" id="app">
                ...
                <article class="content dashboard-page" style="padding-bottom:10px;">
					...
					<form>
                    <h4> Team Decision </h4>
                    <label class='control-label' style='width:100%;'> <br><input id="teamChoice1" name='opt_team' class='radio ' type='radio'  value='Initial accreditation for three (3) years'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
                    <label class='control-label' style='width:100%;'> <input id="teamChoice2"  name='opt_team' class='radio ' type='radio' value='Accreditation not granted'>	<span>Accreditation not granted </span> <br> <hr></label>
                    ...
                    <label class='control-label' style='width:100%;'> <br><input id="commChoice1" name='opt_team' class='radio ' type='radio'  value='Initial accreditation for three (3) years'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
                    <label class='control-label' style='width:100%;'> <input id="commChoice2"  name='opt_team' class='radio ' type='radio' value='Accreditation not granted'>	<span>Accreditation not granted </span> <br> <hr></label>
   			 		<label>Reasons for denial:</label>
					...
					<h4> Board Decision </h4>
                     <label class='control-label' style='width:100%;'> <br><input id="boardChoice1" name='opt_team' class='radio ' type='radio'  value='Initial accreditation for three (3) years'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
                    <label class='control-label' style='width:100%;'> <input id="boardChoice2"  name='opt_team' class='radio ' type='radio' value='Accreditation not granted'>	<span>Accreditation not granted </span> <br> <hr></label>
   			 		<label>Reasons for denial:</label>
   			 		<input type='text' id="boardArea" name='areas' style="width:100px;">
   			 		</form>
					<br>
