...
<source src="assets/vid.mp4" type="video/mp4">
 ...
 <c:set var="news" scope="session" value="${News}"/>
            ...
            <div id="welcome">
			<h1> <c:out value="${news.getTitle()}"/></h1>
			
						<button type="button"  style="float:right; position:relative;left:-50px; top:-52px; color:#3c4731;" class="btn btn-oval btn-secondary" onclick="location.href='addNews.jsp';"><em class="fa fa-plus"></em><b> Add News</b></button>
			   ...
			   <header class="header" id="customheader">
                ...
                <article class="content dashboard-page"  >
                    <section class="section" style="position: relative; top:-135px; left:-25px; width:100%;" >
                   


<h2>      <c:out value="${news.getTitle()}"/>   </h2>

<h5> <c:out value="${news.getDate()}"/></h5>
<br><br>
