        ...
        <div class="main-wrapper" style="z-index:1;">
            <div class="app" id="app">
                ...
                <article class="content dashboard-page" style="padding-bottom:10px;">
                    <h4><b><a href="ConfirmationPage?surveyID=${surveyID}">< Back to Survey </a></b></h4>
                    <br>
					<div>
					<form>
                    <h4> Team Decision </h4>
                    <label class='control-label' style='width:100%;'> <br><input id="teamChoice1" name='opt_team' class='radio ' type='radio'  value='Eligible for formal survey after six months to one year'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
                    ...
                    <label class='control-label' style='width:100%;'> <br><input id="commChoice1" name='opt_team' class='radio ' type='radio'  value='Eligible for formal survey after six months to one year'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
					...
					<h4> Board Decision </h4>
                     <label class='control-label' style='width:100%;'> <br><input id="boardChoice1" name='opt_team' class='radio ' type='radio'  value='Eligible for formal survey after six months to one year'>	<span>Initial accreditation for three (3) years </span> <br> <hr></label>
