									...
									<div class="form-group row">
	                                     <div class="col-xs-2">
	                                         <label>Honorifics:</label>
	                                          <input type="text" class="form-control underlined" id="surveyName" value="${bm.getHonorifics()}" name="honorifics" list="honorificsSuggestions">
	                                         <datalist id="honorificsSuggestions">
	                                         </datalist>
	                                     </div>
	                                     <div class="col-xs-4">
	                                         <label>First Name:</label>
	                                         <input type="text" class="form-control underlined" id="surveyName" value="${bm.getFirstName()}" name="firstName">
	                                     </div>
	                                     <div class="col-xs-2">
	                                         <label>Middle Initial:</label>
	                                         <input type="text" class="form-control underlined" id="surveyName" value="${bm.getMiddleName()}" name="middleName">
	                                     </div>
	                                     <div class="col-xs-4">
	                                         <label>Last Name:</label>
	                                         <input type="text" class="form-control underlined" id="surveyName" value="${bm.getLastName()}" name="lastName">
	                                     </div>
                               		</div>
                                 	<div class="form-group row">
                                     	<div class="col-xs-4">
	                                    ...
	                                    <div class="col-xs-4">
	                                     	<label>Year:</label>
											<input type="text" pattern="\d*" maxlength="4" value="${bm.getYear()}" class="form-control underlined" onkeypress="return isNumberKey(event)" id="surveyName" name="year">
	                                     </div>
                                	 </div>
								</section>
                              </div>
											...
											<div class="form-group row">
	                                       		<div class="col-xs-4">
	                                            	<label>Position:</label>
							 						<input type="text" class="form-control underlined" id="surveyName" value="${bm.getPosition()}" name="position" list="positionSuggestions">
							                        <datalist id="positionSuggestions">
								                    </datalist>
												</div>
												<div class="col-xs-4">
	                                            	<label>Institution:</label>
							 						<input type="text" class="form-control underlined" id="surveyName" value="${bm.getInstitution()}" name="institution" list="instSuggestions">
							                        <datalist id="instSuggestions">
								                    </datalist>
												</div>
	                                            <div class="col-xs-4">
													<label>City:</label>
							 						<input type="text" class="form-control underlined" id="surveyName" value="${bm.getCity()}" name="city" list="citySuggestions">
