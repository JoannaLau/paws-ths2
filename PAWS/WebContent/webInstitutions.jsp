...
<source src="assets/vid.mp4" type="video/mp4">
			...
			<button type="button"  style="float:right; position:relative;left:-50px; top:-52px; color:#3c4731;" class="btn btn-oval btn-secondary" onclick="location.href='./SyncInstitutions';"><b>&nbsp;Sync Changes</b></button>
			   ...
			   <header class="header" id="customheader">
                ...
                <article class="content dashboard-page"  >
                    <section class="section" style="position: relative; top:-135px; left:-25px; width:105%;" >
                     <label>This is the list of institutions whose details have been changed. (Including institution's programs and their details)</label>
											     ...
											     <table id="smarttable" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody id = "tableInstitutions">
													 ...
													 <c:forEach items="${institutions}" var="inst" >
														<tr>
															<td> <c:out value="${inst.getDateChanged()}"/> </td>
