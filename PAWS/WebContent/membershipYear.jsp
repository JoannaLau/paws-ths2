...
<source src="assets/vid.mp4" type="video/mp4">
            ...
            <div id="welcome">
			<h1>Membership for the year ${year}</h1>
                ...
                <article class="content dashboard-page"  >
			       ...
			       <a href="MembershipInfographics"> Membership </a> &nbsp;> List of Member Schools for ${year}
    			</h3>		
											     ...
											     <table id="smarttable" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody id = "tableInstitutions">
													 ...
													 <c:forEach items="${spList}" var="spList" >
														<tr onclick="window.document.location='ViewInstitution?institutionID='+'${spList.getInstitutionID()}';">
															<td> <c:out value="${spList.getInstitution()}"/> 
															<td> <c:out value="${spList.getProgramName()}"/> </td>
															<td> <c:out value="${spList.getDegreeName()}"/> </td>
															<td> <c:out value="${spList.getEducLevel()}"/> </td>
															<td> <c:out value="${spList.getDateAdded()}"/> </td>
