				...
				<article class="content grid-page">
                    <div class="title-block">
                        <h3 class="title" style="float:left;">
							<a href="SchoolSystems"><em class="fa fa-arrow-circle-left"></em> School Systems List </a> 
						</h3>
...
<!--                                                 <div class="col-md-12"> -->
<!-- 													<br> -->
<!--                                                     <button type="button" style="float:right; width:260px;"  class="btn btn-secondary btn-sm" onclick="location.href='addProgram_sch.html';"><em class="fa fa-plus"></em>Add Institutions to this School System</button><br> -->
<!--                                                  </div> -->
                                            </div>
...
<%-- 												         	 <a href="EditAccreditor?accreditorID=<c:out value='${inst.getInstitutionID()}'/>">Edit</a> --%>
<%-- 												        	  <a href="DeleteAccreditor?accreditorID=<c:out value='${inst.getInstitutionID()}'/>">Delete</a></td> --%>
												        	</td>
														</tr>
													</c:forEach>
