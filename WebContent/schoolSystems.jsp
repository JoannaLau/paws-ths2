		...
		<video poster="assets/banner.jpg" id="bgvid"  playsinline autoplay muted loop>
			...
			<source src="assets/vid.mp4" type="video/mp4">
						...
						<h1>List of School Systems</h1>
									...
									<button type="button"  style="float:right; position:relative;left:-50px; top:-52px; color:#3c4731;" class="btn btn-oval btn-secondary" onclick="location.href='addSchoolSystem.jsp';"><em class="fa fa-plus"></em><b> Add School System</b></button>
